...
<div class="container">
    ...
    <div class="action-buttons">
        <div class="button-container">
            ...
            <p class="button-text">Dr. Satish Salunkhe (Child Specialist)</p>
        </div>

        <div class="button-container">
            <button onclick="openPDF2()" class="action-button">Prescription 2</button>
            <p class="button-text">Dr. Suraj Shirsath (Ayurveda)</p>
        </div>

        <div class="button-container">
            <button onclick="openPDF3()" class="action-button">Prescription 3</button>
            <p class="button-text">Dr. Nilesh Mhaskar (Pulmonologist)</p>
        </div>

        <div class="button-container">
            <button onclick="openPDF4()" class="action-button">Prescription 4</button>
            <p class="button-text">Dr. Surendra Patil (Pulmonologist)</p>
        </div>

        <div class="button-container">
            <button onclick="openPDF5()" class="action-button">Prescription 5</button>
            <p class="button-text">Dr. Chudaman Patil (Pulmonologist)</p>
        </div>
    </div>
</div>
